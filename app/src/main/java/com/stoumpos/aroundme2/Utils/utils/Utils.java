...
public class Utils {
     ...
     * @return
     */
   /* public static String createChat(String loggedUserUid, String userUid) {
        String chatKey = FirebaseDatabase.getInstance()
                .getReference(ConstantsFirebase.FIREBASE_LOCATION_CHAT)
                .push()
                .getKey();

        Utils.makeFriends(loggedUserUid, userUid, chatKey);
        Utils.makeFriends(userUid, loggedUserUid, chatKey);
        return chatKey;
    }*/
   ...
   /* private static void makeFriends(String userEmail, String userFriend, String key) {
        FirebaseDatabase.getInstance().getReference(ConstantsFirebase.FIREBASE_LOCATION_USER_FRIENDS).child(userEmail).child(userFriend).setValue(key);
    }*/
