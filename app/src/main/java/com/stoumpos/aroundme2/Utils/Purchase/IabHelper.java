...
package com.stoumpos.aroundme2.Utils.Purchase;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        // serviceIntent.setClassName("com.google.android.c2dm.intent", "REGISTER");
        Intent serviceIntent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.d("myapp", "iabHelper inventory query");
                }
                catch (IabException ex) {
                    result = ex.getResult();
                    Log.d("myapp", "iabHelper inventory error");
                }
