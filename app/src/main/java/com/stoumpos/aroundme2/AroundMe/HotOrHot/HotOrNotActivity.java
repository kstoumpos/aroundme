package com.stoumpos.aroundme2.AroundMe.HotOrHot;
...
import com.stoumpos.aroundme2.Adapters.HotOrnotAdapter;
...
import com.stoumpos.aroundme2.AroundMe.Profile.UserProfile;
...
public class HotOrNotActivity extends BaseActivity implements ActivityWithToolbar {
    ...
    private com.stoumpos.aroundme2.Adapters.HotOrnotAdapter HotOrnotAdapter;
    private int i;
